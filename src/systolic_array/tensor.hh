...
class TensorIndexIterator {
 public:
  ...
  TensorIndexIterator(const TensorIndexIterator& other)
      : dims(other.dims), effecDims(other.effecDims), padding(other.padding),
        halo(other.halo), atEnd(other.atEnd),
        advanceOne(other.advanceOne){
  ...
  // Assignment operator
  TensorIndexIterator& operator=(const TensorIndexIterator& other) {
    if (this != &other) {
      state = other.state;
      dims = other.dims;
...
class TensorRegionIndexIterator : public TensorIndexIterator {
 public:
  ...
  // Copy constructor
  TensorRegionIndexIterator(const TensorRegionIndexIterator& other)
      : TensorIndexIterator(other), origin(other.origin),
        regionSize(other.regionSize), stride(other.stride) {
    state = origin;
  }
  ...
  // Assignment operator
  TensorRegionIndexIterator& operator=(const TensorRegionIndexIterator& other) {
    if (this != &other) {
