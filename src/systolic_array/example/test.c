...
#include "systolic_array_connection.hh"
...
int main() {
  ...
  // int input_dims[4] = { 1, 224, 224, 3 };
  // int weight_dims[4] = { 64, 7, 7, 3 };
  // int output_dims[4] = { 1, 112, 112, 64 };
  // int input_halo_pad[4] = { 3, 3, 3, 3 };
  ...
  //conv2(input_dims,weight_dims,output_dims,input_halo_pad,stride);
