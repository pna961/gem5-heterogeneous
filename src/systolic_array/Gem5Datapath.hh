...
#include "systolic_sys_connection.hh"
...
class Gem5Datapath : public ClockedObject {
 ...
 public:
  ...
  Gem5Datapath(const Params &params,
      ...
      : ClockedObject(params), spadPort(this,
        ...
        spadMasterId(_system->getRequestorId(this, name() + ".spad")),
        cachePort(this, "cache_port"),
        cacheMasterId(_system->getRequestorId(this, name() + ".cache")),
        acpPort(this, "acp_port"),
        acpMasterId(_system->getRequestorId(this, name() + ".acp")),
  ...
  virtual void wakeupCpuThread() {
    ...
    // cpuThread->activate();
    ThreadContext* cpuThread = system->threads[context_id];
    cpuThread->activate();
    // ThreadContext* cpuThread = nullptr;
    // system->registerThreadContext(cpuThread, context_id);
 ...
 protected:
  ...
  RequestorID getSpadMasterId() const { return spadMasterId; }
  RequestorID getCacheMasterId() const { return cacheMasterId; }
  RequestorID getAcpMasterId() const { return acpMasterId; }
  ...
  SpadPort spadPort;
  RequestorID spadMasterId;

  // Coherent port to the cache.
  CachePort cachePort;
  RequestorID cacheMasterId;

  // ACP port to the system's L2 cache.
  AcpPort acpPort;
  RequestorID acpMasterId;
